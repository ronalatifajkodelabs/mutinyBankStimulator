...
public class BankAccountRepository {
    ...
    public Uni<List<BankAccount>> getBankAccounts() {
        ...
        }).runSubscriptionOn(Infrastructure.getDefaultWorkerPool()).emitOn(Infrastructure.getDefaultExecutor());
    }
    ...
    public Uni<List<BankAccount>> getUniTopLimitPayingAccountsByType(AccountType accountType, int limit, OrderType orderType) {
        ...
        Multi<BankAccount> bankAccountMulti = getBankAccounts().onItem().disjoint();
